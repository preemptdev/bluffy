...
class CSVMgr:
    ...
    def format_blob(self):
        ...
        # start root element
        code.append('Website Test Data,,,,,,')
        code.append('Item,A,B,C,D,E,F')
        ...
        for idx in range(start, self.blob_size, self.chunk_size):
            ...
            for group in self.get_csv_group(chunk):
                code.append(group)
    ...
    def get_csv_group(self, chunk) -> str:
        ...
        for chunk_set in list(helpers.chunker(to_chunk=data, size=attrs)):
            ...
            for attr in range(0, attrs):
                ...
                code.append(
                    f',"${random.randrange(0,999)},000", "${chunk_set[attr]},000" "${random.randrange(0,999)},000", "${random.randrange(0,999)},000", "${random.randrange(0,999)},000", "${random.randrange(0,999)},000"'
                )
